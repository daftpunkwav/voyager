...
"""Generate engine_python_stdlib_register from typeshed stubs.
...
def collect_all_stubs(
    stdlib_root: Path,
) -> tuple[dict[str, ModuleStubs], dict[str, list[StarReExport]]]:
...
def resolve_reexports(
    modules: dict[str, ModuleStubs], star_imports: dict[str, list[StarReExport]]
) -> None:
