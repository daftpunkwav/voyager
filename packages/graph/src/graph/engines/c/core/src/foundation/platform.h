...
/* Resolve the graph database cache directory.
 * Priority: env var ENGINE_CACHE_DIR > ~/.cache/graph-engine (default).
 * Returns a static buffer, or NULL if the home directory is unavailable. */
