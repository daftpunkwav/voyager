...
/* Defined by asset_pack_stub.c for all builds (the frontend asset service has
 * been removed; only the stub remains for compatibility with existing
 * includes/symbols). No frontend payload bytes live in it. */
