...
GUARDED_MODULES = [
    "subagent/modes/cot.py",
    "subagent/modes/plan_execute.py",
    "subagent/modes/tot.py",
    "subagent/modes/got.py",
    "subagent/modes/react.py",
    "subagent/modes/reflexion.py",
    "context/editor.py",
    "context/plan_gate.py",
    "context/usage.py",
    "memory/distill.py",
    "master/arbiter.py",
    "master/synthesize.py",
    "master/proactive.py",
    "master/goal_driver.py",
    "master/sessions.py",
    "master/master.py",
