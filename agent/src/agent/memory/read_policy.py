...
duplicated. The graph-side join (semantic.node_id) stays out of scope:
this module only reads the agent's own memory stores.
"""
...
def render_relevant_recall(
    ...
    *,
    ...
    already on a resident card are skipped; the layer is trimmed
